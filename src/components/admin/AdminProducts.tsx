            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  className="relative w-full aspect-square bg-brand-50 dark:bg-slate-800/80 rounded-2xl p-4 flex items-center justify-center overflow-hidden cursor-pointer"
                >
                  {p.imageUrl ? (
                    <img
                      src={p.imageUrl}
                  ...
                  {isAdjusting ? (
                    <div className="flex items-center gap-1.5 p-1 bg-slate-100 dark:bg-slate-800 rounded-xl">
                      ...
                      <button
                        ...
                        className="p-1 bg-brand-600 text-white rounded-lg hover:bg-emerald-700 transition"
                      >
                    ...
                    <div className="flex items-center gap-1.5 w-full">
                      <button
                        ...
                        className="flex-1 py-1.5 px-2 bg-slate-100 hover:bg-brand-600 hover:text-white dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-[11px] font-extrabold rounded-xl transition flex items-center justify-center gap-1"
                      ...
                      <button
                        ...
                        className="flex-1 py-1.5 px-2 bg-slate-100 hover:bg-brand-600 hover:text-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-[11px] font-extrabold rounded-xl transition flex items-center justify-center gap-1"
                      >
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between sm:justify-end gap-3 shrink-0">
                  ...
                  <button
                    onClick={() => setDetailProduct(p)}
                    className="flex items-center gap-1.5 px-3 py-2 bg-slate-100 hover:bg-brand-600 hover:text-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-extrabold text-xs rounded-xl transition"
                  >
                  ...
                  {isAdjusting ? (
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-brand-600 text-white text-xs font-extrabold rounded-xl hover:bg-emerald-700 transition flex items-center gap-1"
                    >
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 p-6 space-y-5">
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
              <button
                ...
                className="px-5 py-2.5 bg-brand-600 text-white text-xs font-extrabold rounded-xl hover:bg-brand-700 dark:bg-white dark:text-black transition flex items-center gap-1.5"
              >
